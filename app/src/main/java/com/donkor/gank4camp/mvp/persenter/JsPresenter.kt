...
import com.donkor.gank4camp.mvp.model.JsModel
 ...
 */
class JsPresenter(context: Context, view: CommonContract.View) : CommonContract.Presenter {
    private var mContext: Context? = null
    private var mView: CommonContract.View? = null
    private val mModel: JsModel by lazy {
        JsModel()
    }
