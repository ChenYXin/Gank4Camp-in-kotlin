...
import com.donkor.gank4camp.mvp.model.ExpandModel
 ...
 */
class ExpandPresenter(context: Context, view: CommonContract.View) : CommonContract.Presenter {
    private var mContext: Context? = null
    private var mView: CommonContract.View? = null
    private val mModel: ExpandModel by lazy {
        ExpandModel()
    }
