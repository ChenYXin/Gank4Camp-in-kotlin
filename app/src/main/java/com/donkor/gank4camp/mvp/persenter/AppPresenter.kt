...
import com.donkor.gank4camp.mvp.model.AppModel
 ...
 */
class AppPresenter(context: Context, view: CommonContract.View) : CommonContract.Presenter {
    private var mContext: Context? = null
    private var mView: CommonContract.View? = null
    private val mModel: AppModel by lazy {
        AppModel()
    }
